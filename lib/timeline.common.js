/*!
 * pp-timeline - Vanilla JavaScript horizontal / vertical timeline component
 * @version 1.0.4
 * @link https://github.com/squarechip/timeline
 * @author Mike Collins
 * 杭州物点网络科技有限公司
 */
module.exports =
...
module.exports = __webpack_require__.p + "img/arrow-left.52053a1b.svg";
...
// load the styles
var content = __webpack_require__("8879");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("7827ed0e", content, true, {"sourceMap":false,"shadowMode":false});
...
module.exports = __webpack_require__.p + "img/arrow-right.ae09b573.svg";
...
// EXTERNAL MODULE: ./src/scss/timeline.scss
var timeline = __webpack_require__("be37");
...
function timeline_timeline(collection, options) {
  var timelines = [];
  ...
  function setHeightandWidths(tl) {
    ...
    function setHeights() {
      ...
      var transformString = "translateY(".concat(tl.settings.horizontalStartPosition === 'bottom' ? oddIndexTallest : evenIndexTallest, "px)");
      tl.items.forEach(function (item, i) {
        if (i % 2 === 0) {
  ...
  function addNavigation(tl) {
    if (tl.items.length > tl.settings.visibleItems) {
      ...
      var topPosition = tl.settings.horizontalStartPosition === 'bottom' ? tl.items[1].offsetHeight : tl.items[0].offsetHeight;
...
if (window.jQuery) {
  (function ($) {
    $.fn.timeline = function (opts) {
      timeline_timeline(this, opts);
      return this;
    };
  })(window.jQuery);
}

/* harmony default export */ var js_timeline = (timeline_timeline);
...
/* harmony default export */ var src = (js_timeline);
...
/******/ });
//# sourceMappingURL=timeline.common.js.map